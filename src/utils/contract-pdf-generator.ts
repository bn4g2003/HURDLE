...
export function generateContractHTML(
  ...
  const logoUrl = centerInfo.logoUrl || '/huedle.jpg';
  ...
  return `
    ...
    <table style="width: 100%; font-size: 11px; margin: 6px 0;">
      ...
      <tr>
        <td><strong>Mã học viên:</strong> ${contract.studentId ? `Hdl-HV-${contract.studentId.slice(-10)}` : '---'}</td>
