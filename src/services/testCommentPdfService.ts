 ...
 *
 * Generates PDF reports in HURDLE format for test comments.
...
const HURDLE_HOTLINE = '0967.030.457';
const HURDLE_REFERRAL_MESSAGE = `Chương trình "GỬI LỜI YÊU THƯƠNG" tới bố mẹ có con theo học tại HURDLE!

HURDLE rất cảm ơn bố mẹ khi đã tin tưởng gửi gắm con và giới thiệu thêm bạn bè, con cháu tham gia lớp học. Thay lời cảm ơn và tri ân tới bố mẹ, khi giới thiệu một học sinh thành công, HURDLE xin gửi tặng 200k/1 bạn giới thiệu thành công (Trừ vào khóa học tới của con hoặc tiền mặt).

HURDLE xin cảm ơn bố mẹ thật nhiều ạ!`;
...
const COLORS = {
  ...
  border: '#2E86AB',          // HURDLE accent blue
...
/**
 * Generate HTML template for HURDLE PDF
 */
    ...
    ">
      ...
      <div style="display: flex; align-items: flex-start; margin-bottom: 15px;">
        <div style="flex-shrink: 0; margin-right: 15px;">
          <img src="/huedle.jpg" alt="HURDLE Logo" style="width: 100px; height: auto;" crossorigin="anonymous" />
        </div>
        <div style="flex: 1;">
          <div style="font-weight: bold; font-size: 14pt; color: ${COLORS.headerText}; margin-bottom: 4px;">
            HỆ THỐNG ANH NGỮ QUỐC TẾ HURDLE
          </div>
          ${HURDLE_BRANCHES.map(branch => `<div style="font-size: 11pt;">${escapeHtml(branch)}</div>`).join('')}
          <div style="font-size: 11pt;"><strong>Hotline:</strong> ${HURDLE_HOTLINE}</div>
        </div>
      </div>
      ...
      <div style="margin: 20px 0 15px 0; text-align: justify; font-size: 11pt;">
        <div style="font-weight: bold; margin-bottom: 8px;">
          Chương trình "GỬI LỜI YÊU THƯƠNG" tới bố mẹ có con theo học tại HURDLE!
        </div>
        <p style="margin: 0 0 8px 0;">
          HURDLE rất cảm ơn bố mẹ khi đã tin tưởng gửi gắm con và giới thiệu thêm bạn bè, con cháu tham gia lớp học. Thay lời cảm ơn và tri ân tới bố mẹ, khi giới thiệu một học sinh thành công, HURDLE xin gửi tặng 200k/1 bạn giới thiệu thành công (Trừ vào khóa học tới của con hoặc tiền mặt).
        </p>
        <p style="margin: 0;">HURDLE xin cảm ơn bố mẹ thật nhiều ạ!</p>
      </div>
...
/**
 * Generate PDF for a single test comment report (HURDLE format)
 */
