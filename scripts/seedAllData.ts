...
const centerSettings = {
  name: 'HURDLE Edu Center',
  code: 'HURDLE-TTD',
  address: '123 Tân Tây Đô, Đan Phượng, Hà Nội',
  phone: '024-1234-5678',
  email: 'info@hurdle.edu.vn',
  website: 'https://hurdle.edu.vn',
  currency: 'VND',
...
// 2. Branches
const branches = [
  { name: 'HURDLE Tân Tây Đô', code: 'TTD', address: '123 Tân Tây Đô', phone: '024-1234-5678', isMain: true },
  { name: 'HURDLE Mỹ Đình', code: 'MD', address: '456 Mỹ Đình', phone: '024-2345-6789', isMain: false },
];
...
// 5. Staff/Teachers
const staff = [
  { name: 'Nguyễn Thị Lan', position: 'GV Việt', phone: '0901111111', email: 'lan@hurdle.edu.vn', birthDate: '1990-03-15', status: 'Active' },
  { name: 'Trần Văn Hùng', position: 'GV Việt', phone: '0902222222', email: 'hung@hurdle.edu.vn', birthDate: '1988-07-22', status: 'Active' },
  { name: 'Phạm Thị Mai', position: 'GV Việt', phone: '0903333333', email: 'mai@hurdle.edu.vn', birthDate: '1992-11-08', status: 'Active' },
  { name: 'John Smith', position: 'GV Ngoại', phone: '0904444444', email: 'john@hurdle.edu.vn', birthDate: '1985-05-20', status: 'Active' },
  { name: 'Sarah Johnson', position: 'GV Ngoại', phone: '0905555555', email: 'sarah@hurdle.edu.vn', birthDate: '1987-09-12', status: 'Active' },
  { name: 'Lê Thị Hương', position: 'Trợ giảng', phone: '0906666666', email: 'huong@hurdle.edu.vn', birthDate: '1995-12-25', status: 'Active' },
  { name: 'Võ Văn Minh', position: 'Trợ giảng', phone: '0907777777', email: 'minh@hurdle.edu.vn', birthDate: '1996-04-18', status: 'Active' },
];
...
const products = [
  ...
  { name: 'Balo HURDLE', category: 'Phụ kiện', price: 200000, stock: 10, minStock: 8 },
